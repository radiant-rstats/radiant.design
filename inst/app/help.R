...
observeEvent(input$help_design_all, {
  help_switch(input$help_design_all, "help_design")
})
observeEvent(input$help_design_none, {
  help_switch(input$help_design_none, "help_design", help_on = FALSE)
})
